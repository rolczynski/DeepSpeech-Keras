...
#             audio.audio, numcep=self.features_num, **self.params
#         )
#         # feat = self.standardize(feat) if self.is_standardization else feat
#         return feat

class MFCC(features.FeaturesExtractor):

    def __init__(self, features_num: int, is_standardization=True, sample_rate=16000, 
